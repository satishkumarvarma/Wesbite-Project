  ...
  $escaped_ad_num = mysqli_real_escape_string($conn, $email);
    ...
    if ($result) {
      ...
      if (password_verify($userEnteredPassword, $storedHashedPassword)) {
        ...
        echo '<script>alert("Incorrect email or password .Pls stry again")</script>';
      } 
...
mentally healthy.
    ...
    <section class="section-services" id="about">
        <div class="hero">
            <p>Mental well-being encompasses psychological, emotional, and social health. It refers to how we
